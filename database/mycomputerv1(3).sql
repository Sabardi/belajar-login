...
--
-- Host: localhost
-- Generation Time: Jan 14, 2024 at 03:40 AM
...
(2, 'burhan', 'bagu', '123456789'),
(3, 'burhan', 'bagu', '123456789'),
(4, 'ilham', 'bbau', '567890');
...
INSERT INTO `tb_teknisi` (`id_teknisi`, `nama_teknisi`, `alamat`, `spesialis`, `no_hp`) VALUES
(1, 'asep', 'batu nyale', 'service', '08787727272'),
(2, 'burhan', 'bagu', 'seting', '82929'),
(3, 'hahah', 'shshsh', 'sjsjs', 'ssjsjjs');
...
--
ALTER TABLE `tb_teknisi`
  MODIFY `id_teknisi` int(50) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=7;
